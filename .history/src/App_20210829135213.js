    ...
    return (<>
      ...
      <div className='container-fluid'>
        <div className='row row-cols-1 row-cols-md-2 g-2'>
          <div className='col'>
            <button type='button' className='btn bg-success px-2'>{choices[0]}</button>
          </div>
          <div className='col'>
            <button type='button' className='btn bg-success px-2'>{choices[1]}</button>
          </div>
          <div className='col'>
            <button type='button' className='btn bg-success px-2'>{choices[2]}</button>
          </div>
          <div className='col'>
            <button type='button' className='btn bg-success px-2'>{choices[3]}</button>
          </div>
        </div>
      </div>
    </>)
  ...
  return (
    <div className="App container p-md-2 p-lg-5 w-100 d-flex align-items-center">
      ...
      <div className={`container-fluid p-0 ${questionPage}`}>
        <RenderQuestion question={current_question.question} choices={current_question.question}/>
      </div>
    </div>
  );
}
