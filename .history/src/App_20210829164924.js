  ...
  return (
    ...
    <div className="App container px-md-2 px-lg-5 w-100 d-flex align-items-center">
      ...
      <div className={`container-fluid p-0 ${questionPage}`}>
        ...
        <div className='container w-100 d-flex justify-content-around my-2 mx-lg-5'>
          <button type='button' className='btn btn-primary px-5 my-5 fs-5' onClick={nextQuestion} disabled={nextBtn}>Next</button>
          <button type='button' className='btn btn-danger px-5 my-5 fs-5' onClick={showResultPage} disabled={finishBtn}>Finish</button>
