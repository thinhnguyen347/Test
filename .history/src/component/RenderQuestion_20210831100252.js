        ...
        <div className='container-fluid'>
            <div className='row row-cols-1 row-cols-md-2 g-3 g-lg-4'>
                <div className='col d-flex justify-content-center'>
                    <button type='button' className='btn btn-outline-light btn-warning py-3 w-100 fs-3 mx-md-5 rounded-pill text-dark' onClick={checkAnswer} disabled={choiceBtnDisable} i>{choices[0]}</button>
                </div>
                <div className='col d-flex justify-content-center'>
