...
import logo from './component/textnote'
...
function App() {
  ...
  const [statusStartPage, setStatusStartPage] = useState('d-block');
  const [hideResultPage, setHideResultPage] = useState('d-block');




  return (
    <div className="App p-5 w-100">
      <div className={`container-fluid p-0 ${statusStartPage}`}>
