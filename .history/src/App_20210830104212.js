...
function App() {
  ...
  return (
    ...
    <div className="App container px-md-2 px-lg-5 w-100 d-flex align-items-center">
      <div className={`container-fluid p-0 ${(startPage) ? "d-block" : "d-none"}`}>
      ...
      <div className={`container-fluid p-0 ${questionPage}`}>
        <div className={'container-fluid p-0'}>
          ...
          <RenderQuestion question={current_question.question} choices={current_question.choices} checkAnswer={checkAnswer} choiceBtnDisable={choiceBtnDisable/>
        </div>
      ...
      <div className={`container-fluid p-0 ${resultPage}`}>
        ...
        <p className='h3 text-center'>You've got <span className="text-success">{score}</span>  points</p>
