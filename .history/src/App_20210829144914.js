...
function App() {
  ...
  const [score, setScore] = useState('d-none');
      ...
      <div className='container-fluid'>
        <div className='row row-cols-1 row-cols-md-2 g-3 g-lg-4'>
          <div className='col d-flex justify-content-center'>
            <button type='button' className='btn btn-warning py-3 w-100 fs-3 mx-md-5 rounded-pill text-dark' >{choices[0]}</button>
          </div>
          <div className='col d-flex justify-content-center'>
            <button type='button' className='btn btn-warning py-3 w-100 fs-3 mx-md-5 rounded-pill text-dark'>{choices[1]}</button>
          </div>
          <div className='col d-flex justify-content-center'>
            <button type='button' className='btn btn-warning py-3 w-100 fs-3 mx-md-5 rounded-pill'>{choices[2]}</button>
          </div>
          <div className='col d-flex justify-content-center'>
            <button type='button' className='btn btn-warning py-3 w-100 fs-3 mx-md-5 rounded-pill text-dark'>{choices[3]}</button>
          </div>
        </div>
      </div>
    </>)
  ...
  return (
    <div className="App container p-md-2 p-lg-5 w-100 d-flex align-items-center">
      ...
      <div className={`container-fluid p-0 ${questionPage}`}>
        <div className="container-fluid py-2 d-flex justify-content-between fs-4">
<div className="container">Question {currentQuestionNumber+1} of {quiz.length}</div>
