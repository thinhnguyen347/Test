...
function App() {
  ...
  return (
      ...
      <div className="App container px-md-2 px-lg-5 w-100 d-flex flex-column align-items-center">
        ...
        <div className='{`container-fluid p-0 ${questionPage}`}></div>
        ...
        <div className='container w-100 d-flex justify-content-center'>
          <button type='button' className='btn btn-primary px-4 fs-5'>{nextBtn}</button>
        </div>
