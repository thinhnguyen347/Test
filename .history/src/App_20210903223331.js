...
function App() {
  ...
  const [questionPageShown, setQuestionPageShow] = useState(false);
  ...
  return (
    <div className="App container px-md-2 px-lg-5 w-100 d-flex align-items-center">
      ...
      <div
        className={`container-fluid p-0 ${
          questionPageShown ? "d-block" : "d-none"
        }`}
      >
