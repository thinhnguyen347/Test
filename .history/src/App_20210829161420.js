...
function App() {
  ...
  function nextQuestion() {
    ...
    if (currentQuestionNumber < quiz.length) setCurrentQuestionNumber(currentQuestionNumber + 1);

    if (currentQuestionNumber === quiz.length-1) { setNextBtn("d-none"); setFinishBtn("d-block") };


    if (currentQuestionNumber === quiz.length) { setNextBtn("d-none"); setFinishBtn("d-block") };
