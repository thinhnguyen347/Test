...
function App() {
  ...
  useEffect(()=> timerRef.current = setTimeout((nextQuestion(); if (currentQuestionNumber=== quiz.length-1) showResultPage();)=>{

  }, 5000))


  //function callback() { nextQuestion(); if (currentQuestionNumber=== quiz.length-1) showResultPage();}
        ...
        <div className={"container-fluid p-0"}>
          <div className="container-fluid pt-5 pb-2 px-0 d-flex justify-content-between fs-5">
            ...
            <div className="container-fluid text-center">
              <div className="fs-6">Coundown</div>
              <div className="my-2">
                <span className="rounded-pill px-3 py-2">time</span>
              </div>
            </div>
