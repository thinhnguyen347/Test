...
function App() {
  return (
    <div className="App">
      ...
      <ReactAudioPlayer
        src="./component/audio/kid-world.mp3"
        loop
        controls
      />
      <ReactAudioPlayer
        src="./component/audio/correct.mp3"
        loop
        controls
      />
      <ReactAudioPlayer
        src="./component/audio/wrong.mp3"
        loop
        controls
      />
      ...
      <div className="wrapper">
        ...
        <div className="container1 hide">
          <br />
          <div className="num-subs">
            <p className="number"></p>
            <p className="subscore"></p>
          </div>
          <br />
          <p id="question"></p>
          <br>
