...
function App() {
  ...
  function checkAnswer(e) {
    ...
    disableStatus.current="disabled";
    // setChoiceBtn('disabled');
  }
      ...
      <div className='container-fluid'>
        <div className='row row-cols-1 row-cols-md-2 g-3 g-lg-4'>
          <div className='col d-flex justify-content-center'>
            <button ref={disableStatus} type='button' className='btn btn-outline-light btn-warning py-3 w-100 fs-3 mx-md-5 rounded-pill text-dark' onClick={checkAnswer} disabled={choiceBtn}>{choices[0]}</button>
          </div>
          <div className='col d-flex justify-content-center'>
            <button type='button' className='btn btn-outline-light btn-warning py-3 w-100 fs-3 mx-md-5 rounded-pill text-dark' onClick={checkAnswer} disabled={choiceBtn}>{choices[1]}</button>
          </div>
          <div className='col d-flex justify-content-center'>
            <button type='button' className='btn btn-outline-light btn-warning py-3 w-100 fs-3 mx-md-5 rounded-pill text-dark' onClick={checkAnswer} disabled={choiceBtn}>{choices[2]}</button>
          </div>
          <div className='col d-flex justify-content-center'>
            <button type='button' className='btn btn-outline-light btn-warning py-3 w-100 fs-3 mx-md-5 rounded-pill text-dark' onClick={checkAnswer} disabled={choiceBtn}>{choices[3]}</button>
          </div>
        </div>
      </div>
    </>)
    ...
    <div className="App container px-md-2 px-lg-5 w-100 d-flex align-items-center">
      ...
      <div className={`container-fluid p-0 ${questionPage}`}>
        ...
        <div className='container-fluid d-flex justify-content-around my-5 px-lg-5'>
          <button type='button' className='btn btn-primary px-3 px-sm-5 fs-5' onClick={nextQuestion} disabled={nextBtn}>&nbsp;Next&nbsp;</button>
          <button type='button' className='btn btn-danger px-3 px-sm-5 fs-5' onClick={showResultPage} disabled={finishBtn}>Finish</button>
        </div>
      </div>
      <div className={`container-fluid p-0 ${resultPage}`}>
        <img src={logo} className="img-fluid d-block mx-auto pb-5" alt="logo" width="360px" />
        <p className='h2 text-center'>Congratulation!</p>
        <p className='h2 text-center'>You have got {score} points</p>
        <button type="button" className="App-start-btn btn btn-danger btn-lg d-block mx-auto py-2 px-4 fs-3 mt-3" onClick={replay}>Replay</button>
