...
function App() {
  ...
  return (
    <div className="App container p-md-2 p-lg-5 w-100 d-flex justify-content">
      <div className={`container-fluid p-0 ${startPage}`}>
        <img src={logo} className="d-block mx-auto py-5 mt-5" alt="logo" width="360px" />
        <button type="button"  className="btn btn-warning btn-lg d-block mx-auto p-3">Start</button>
      </div>
    </div>
  );
}
